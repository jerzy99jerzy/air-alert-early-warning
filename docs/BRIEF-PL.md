...
```
Document:  docs/BRIEF-PL.md, version 2.8
...
**Bramka jest jedna i jest maszynowa.** Jedno polecenie uruchamia 716 testów,
w tym 13 skryptowanych ataków na własne zabezpieczenia; pokrycie kodu wynosi
95,60% przy podłodze 95%, która nigdy nie jest obniżana. Same ataki też są
