...
**Log defektów ma 125 wpisów.** Każdy zawiera, co się zepsuło, dlaczego nikt
...
twierdziła, że coś jest sprawdzane, a nie było. Osobno zapisano **48 decyzji
...
**Bramka jest jedna i jest maszynowa.** Jedno polecenie uruchamia 696 testów,
w tym 13 skryptowanych ataków na własne zabezpieczenia; pokrycie kodu wynosi
95,39% przy podłodze 95%, która nigdy nie jest obniżana. Same ataki też są
