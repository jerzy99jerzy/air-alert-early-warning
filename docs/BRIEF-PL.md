...
```
Document:  docs/BRIEF-PL.md, version 2.16
...
**Log defektów ma 138 wpisów.** Każdy zawiera, co się zepsuło, dlaczego nikt
...
**Bramka jest jedna i jest maszynowa.** Jedno polecenie uruchamia 773 testy,
