...
```
Document:  docs/BRIEF-PL.md, version 2.15
...
**Log defektów ma 137 wpisów.** Każdy zawiera, co się zepsuło, dlaczego nikt
...
**Bramka jest jedna i jest maszynowa.** Jedno polecenie uruchamia 768 testów,
