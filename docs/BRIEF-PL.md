...
```
Document:  docs/BRIEF-PL.md, version 2.30
...
**Rejestr błędów ma 165 wpisów.** Każdy mówi, co się zepsuło, dlaczego nikt tego
...
że coś jest sprawdzane, a nie było. Osobno zapisano **56 decyzji projektowych**,
...
**Bramka jest jedna i jest maszynowa.** Jedno polecenie uruchamia 1059 testów, w
tym 14 scenariuszy ataku na zabezpieczenia samego projektu; pokrycie kodu
wynosi 96,34% przy progu 95%, którego nigdy się nie obniża. Same ataki także są
