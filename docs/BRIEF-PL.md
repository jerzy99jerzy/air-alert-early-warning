...
```
Document:  docs/BRIEF-PL.md, version 2.17
...
**Log defektów ma 141 wpisów.** Każdy zawiera, co się zepsuło, dlaczego nikt
...
**Bramka jest jedna i jest maszynowa.** Jedno polecenie uruchamia 775 testów,
