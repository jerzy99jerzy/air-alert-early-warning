...
```
Document:  docs/BRIEF.md, version 2.11
...
**The defect log holds 131 entries.** Each states what broke, why nobody
...
**The gate is single and mechanical.** One command runs 729 tests, of which 13
