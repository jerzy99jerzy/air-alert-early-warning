...
```
Document:  docs/BRIEF.md, version 2.14
...
**The defect log holds 136 entries.** Each states what broke, why nobody
...
**The gate is single and mechanical.** One command runs 765 tests, of which 13
