...
```
Document:  docs/BRIEF.md, version 2.19
...
**The defect log holds 144 entries.** Each states what broke, why nobody
...
**The gate is single and mechanical.** One command runs 777 tests, of which 13
