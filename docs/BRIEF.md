...
documentation claimed something was checked and it was not. Separately, **48
...
**The gate is single and mechanical.** One command runs 696 tests, of which 13
are scripted attacks against the project's own controls; code coverage is
95.39% against a floor of 95% that is never lowered. The attacks are themselves
