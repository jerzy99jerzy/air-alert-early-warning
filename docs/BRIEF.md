...
```
Document:  docs/BRIEF.md, version 2.17
...
**The defect log holds 141 entries.** Each states what broke, why nobody
...
**The gate is single and mechanical.** One command runs 775 tests, of which 13
