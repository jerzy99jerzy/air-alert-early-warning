...
```
Document:  docs/BRIEF.md, version 2.13
...
**The defect log holds 134 entries.** Each states what broke, why nobody
...
documentation claimed something was checked and it was not. Separately, **50
...
**The gate is single and mechanical.** One command runs 762 tests, of which 13
are scripted attacks against the project's own controls; code coverage is
95.50% against a floor of 95% that is never lowered. The attacks are themselves
