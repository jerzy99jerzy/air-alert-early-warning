...
```
Document:  docs/BRIEF.md, version 2.6
...
**The defect log holds 125 entries.** Each states what broke, why nobody
...
documentation claimed something was checked and it was not. Separately, **49
...
**The gate is single and mechanical.** One command runs 700 tests, of which 13
are scripted attacks against the project's own controls; code coverage is
95.27% against a floor of 95% that is never lowered. The attacks are themselves
