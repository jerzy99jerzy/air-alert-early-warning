...
```
Document:  docs/BRIEF.md, version 2.22
...
**The defect log holds 152 entries.** Each states what broke, why nobody
...
**The gate is single and mechanical.** One command runs 911 tests, of which 13
are scripted attacks against the project's own controls; code coverage is
95.75% against a floor of 95% that is never lowered. The attacks are themselves
