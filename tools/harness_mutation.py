...
MUTATIONS: tuple[Mutation, ...] = (
    ...
    Mutation(
        attack="test_a4_perfect_recall_does_not_buy_past_the_alarm_budget",
        row="MT4",
        path="mavo/baserate.py",
        old="    elif assessment.alarm_rate_per_week > alarm_budget:",
        new="    elif False:",
        disables="the alarm-rate gate condition",
    ),
    Mutation(
        attack="test_a5_budget_cannot_be_spent_twice",
        row="MT5",
        path="mavo/policy.py",
        old="        if allocated > self.total_budget_per_week:",
        new="        if False:",
        disables="refusal to over-allocate the shared budget",
    ),
    Mutation(
