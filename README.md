...
[![defects logged 123](https://img.shields.io/badge/defects%20logged-123-informational)](docs/METHODOLOGY.md)
...
| Defects logged with their class | 123, the count pinned against the log itself |
| Decisions recorded with reopen conditions | 46, counted from the log itself |
| Releases | 129 in the changelog; tags are fewer and some are cumulative (A11) |
