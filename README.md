...
[![tests 595](https://img.shields.io/badge/tests-595-brightgreen)](tests/)
...
| | Files | Lines |
| --- | --- | --- |
| Package `mavo/` | 22 | 8,032 |
| Tests | 58 | 11,288 |
| Tools | 26 | 7,110 |
| Documentation | 66 | 25,913 |
...
| Tests | 595, of which 13 are scripted attacks |
