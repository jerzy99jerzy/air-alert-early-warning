...
[![tests 546](https://img.shields.io/badge/tests-546-brightgreen)](tests/)
...
[![defects logged 105](https://img.shields.io/badge/defects%20logged-105-informational)](docs/METHODOLOGY.md)
...
| | Files | Lines |
| --- | --- | --- |
| Package `mavo/` | 20 | 6,849 |
| Tests | 55 | 10,158 |
| Tools | 25 | 7,106 |
| Documentation | 60 | 24,239 |
...
| Tests | 546, of which 13 are scripted attacks |
...
| Defects logged with their class | 105, the count pinned against the log itself |
| Decisions recorded with reopen conditions | 35, counted from the log itself |
