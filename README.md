...
[![tests 259](https://img.shields.io/badge/tests-259-brightgreen)](tests/)
[![coverage 96.14%](https://img.shields.io/badge/coverage-96.14%25-brightgreen)](Makefile)
...
[![defects logged 56](https://img.shields.io/badge/defects%20logged-56-informational)](docs/METHODOLOGY.md)
...
| Tests | 259, of which 13 are scripted attacks |
...
| Defects logged with their class | 56, the count pinned against the log itself |
