...
[![tests 775](https://img.shields.io/badge/tests-775-brightgreen)](tests/)
...
[![defects logged 141](https://img.shields.io/badge/defects%20logged-141-informational)](docs/METHODOLOGY.md)
...
| Tests | 775, of which 13 are scripted attacks |
...
| Defects logged with their class | 141, the count pinned against the log itself |
| Decisions recorded with reopen conditions | 51, counted from the log itself |
| Releases | 147 in the changelog; tags are fewer and some are cumulative (A11) |
