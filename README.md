...
[![tests 500](https://img.shields.io/badge/tests-500-brightgreen)](tests/)
...
[![defects logged 97](https://img.shields.io/badge/defects%20logged-97-informational)](docs/METHODOLOGY.md)
...
| Tests | 500, of which 13 are scripted attacks |
...
| Defects logged with their class | 97, the count pinned against the log itself |
| Decisions recorded with reopen conditions | 32, counted from the log itself |
