...
[![defects logged 160](https://img.shields.io/badge/defects%20logged-160-informational)](docs/METHODOLOGY.md)
...
| Defects logged with their class | 160, the count pinned against the log itself |
| Decisions recorded with reopen conditions | 54, counted from the log itself |
| Releases | 158 in the changelog; tags are fewer and some are cumulative (A11) |
