...
[![tests 527](https://img.shields.io/badge/tests-527-brightgreen)](tests/)
[![coverage 96.44%](https://img.shields.io/badge/coverage-96.44%25-brightgreen)](Makefile)
...
[![defects logged 103](https://img.shields.io/badge/defects%20logged-103-informational)](docs/METHODOLOGY.md)
...
| | Files | Lines |
| --- | --- | --- |
| Package `mavo/` | 20 | 6,663 |
| Tests | 54 | 9,719 |
| Tools | 24 | 6,832 |
| Documentation | 59 | 23,645 |
...
| Tests | 527, of which 13 are scripted attacks |
| Coverage | 96.44% against a floor of 95, a ratchet that is never lowered |
...
| Defects logged with their class | 103, the count pinned against the log itself |
