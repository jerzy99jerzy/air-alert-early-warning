...
[![tests 938](https://img.shields.io/badge/tests-938-brightgreen)](tests/)
...
| | Files | Lines |
| --- | --- | --- |
| Package `mavo/` | 26 | 11,655 |
| Tests | 74 | 16,499 |
| Tools | 28 | 7,990 |
| Documentation | 75 | 35,683 |
...
| Tests | 938, of which 13 are scripted attacks |
...
| Releases | 159 in the changelog; tags are fewer and some are cumulative (A11) |
