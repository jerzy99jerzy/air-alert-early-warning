...
[![tests 1012](https://img.shields.io/badge/tests-1012-brightgreen)](tests/)
[![coverage 96.26%](https://img.shields.io/badge/coverage-96.26%25-brightgreen)](Makefile)
...
[![defects logged 162](https://img.shields.io/badge/defects%20logged-162-informational)](docs/METHODOLOGY.md)
...
| | Files | Lines |
| --- | --- | --- |
| Package `mavo/` | 27 | 12,379 |
| Tests | 75 | 16,932 |
| Tools | 28 | 7,990 |
| Documentation | 75 | 35,779 |
...
| Tests | 1012, of which 13 are scripted attacks |
| Coverage | 96.26% against a floor of 95, a ratchet that is never lowered |
...
| Defects logged with their class | 162, the count pinned against the log itself |
| Decisions recorded with reopen conditions | 55, counted from the log itself |
| Releases | 160 in the changelog; tags are fewer and some are cumulative (A11) |
